...
CELERY_WORKER_POOL = os.getenv("CELERY_WORKER_POOL") # для windows (закомментируй для linux, чтобы по умолчанию использовался prefork)
...
DEFAULT_FROM_EMAIL = 'noreply@greentrack.local'

# Настройка почты (прод)
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
# EMAIL_HOST = 'smtp.gmail.com'
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'your-email@gmail.com'
# EMAIL_HOST_PASSWORD = 'your-app-password'  # Не пароль от аккаунта!
